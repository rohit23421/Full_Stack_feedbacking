import GradiantHeader from "@/components/gradient-header";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground">
              Share your suggestions and feature requests from the community
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
            ...
            <CardTitle>Vote & Priorities</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground">
              Upvote ideas you ove to help us understand what matters the most
            </p>
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardTitle>See Reults</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground">
              Watch as your feedback transform into real features and
              improvements
            </p>
          </CardContent>
        </Card>
